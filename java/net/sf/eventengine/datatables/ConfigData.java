...
public class ConfigData
{
	...
	public int MAX_BUFF_COUNT;
	public boolean ANTI_AFK_ENABLE;
	...
	public void load()
	{
		...
		ANTI_AFK_ENABLE = settings.getBoolean("EventAntiAfk", true);
		AFK_CHECK_TIME = settings.getInt("EventAfkTime", 30);
